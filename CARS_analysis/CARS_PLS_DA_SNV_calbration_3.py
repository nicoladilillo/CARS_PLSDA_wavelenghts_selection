...
c = CARS(path, col_group, X_df, MAX_COMPONENTS=3, CV_FOLD=5, calibration=True, test_percentage=0.2)
c.perform_pca()
c.cars_model(R=R, N=100, rmsecv=True, ars=True , MC_SAMPLES=0.8, start=501)
c.save_results()
