...
c = CARS(path, col_group, X_df, MAX_COMPONENTS=2, CV_FOLD=5, calibration=True, test_percentage=0.2)
c.perform_pca()
c.cars_model(R=R, N=100, rmsecv=True, ars=True , MC_SAMPLES=0.8, start=500)
c.save_results()
